#!/glade/work/jedipara/cheyenne/spack-stack/miniconda-3.9.12/bin/python3
...
DIR_DATA = "/glade/scratch/lgchen/data/ERA5forSODA/original/netCDF/6hr"
...
# FN_VAR   = [('dt2m', '6hr', False), ('mslp', '6hr', False), ('rain', '1dy', True)  \
#          ,  ('snowfall', '1dy', True), ('ssrd', '3hr', True), ('strd', '6hr', True), ('t2m', '6hr', False)  \
#          ,  ('tp', '1dy', True), ('u10', '6hr', False), ('v10', '6hr', False)]
START_YEAR = 2022
END_YEAR   = 2022
...
# dict_jday[2021] = 44195  # corresponds to 20210101-00:00:00
dict_jday[2022] = 44560  # corresponds to 20220101-00:00:00
